...
This repo contains material for the Corda two day training course. This lession can be optionally prefaced by the content found in the hello-corda directory in the root of this repository.
